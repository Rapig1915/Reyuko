...
namespace UWPDemo.Pages.Sales.Return
{
    /// <summary>
    /// An empty page that can be used on its own or navigated to within a Frame.
    /// </summary>
    public sealed partial class Sales_Return : Page
    {
        private ObservableCollection<Sales_ReturnItem> m_TableData;
        ...
        public Sales_Return()
        {
            ...
            headerList.Add(new HeaderItem { Name = "Sales Return No.", Width = 100 });
            ...
            m_TableData = new ObservableCollection<Sales_ReturnItem>();
            Refresh();
        }
        public void Refresh()
        {
            ...
            foreach (Sales_ReturnItem item in m_TableData)
            {
