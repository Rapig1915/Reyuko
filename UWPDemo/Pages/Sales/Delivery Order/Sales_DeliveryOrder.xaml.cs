...
namespace UWPDemo.Pages.Sales.Delivery_Order
{
    /// <summary>
    /// An empty page that can be used on its own or navigated to within a Frame.
    /// </summary>
    public sealed partial class Sales_DeliveryOrder : Page
    {
        private ObservableCollection<Sales_DeliveryOrderItem> m_TableData;
        private List<HeaderItem> m_HeaderData;

        public Sales_DeliveryOrder()
        {
            ...
            headerList.Add(new HeaderItem { Name = "Delivery Order No.", Width = 100 });
            headerList.Add(new HeaderItem { Name = "Date", Width = 100 });
            headerList.Add(new HeaderItem { Name = "Sales Order No.", Width = 100 });
            ...
            m_TableData = new ObservableCollection<Sales_DeliveryOrderItem>();
            Refresh();
        }
        public void Refresh()
        {
            ...
            foreach (Sales_DeliveryOrderItem item in m_TableData)
            {
