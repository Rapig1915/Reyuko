...
{
    public sealed partial class ListItemDetailControl : UserControl
    {

        public async static void ListItemDetail(string str, string strContent)
        {
            var detail = new ListItemDetailControl(str, strContent);
        ...
        public ListItemDetailControl(string strTitle, string strContent)
        {
